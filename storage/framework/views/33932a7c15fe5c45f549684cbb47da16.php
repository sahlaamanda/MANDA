...
<div class="container">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <?php if($sale->status === 'COMPLETED'): ?>
            <a href="<?php echo e(route('admin.penjualan.struk', $sale->id)); ?>" target="_blank" class="btn btn-success">
                🖨️ Cetak Struk
            </a>
        <?php endif; ?>
    </div>
    ...
    <div class="mt-3">
        <a href="<?php echo e(route('admin.penjualan.index')); ?>" class="btn btn-secondary">
            Kembali
        </a>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\amanda\resources\views/penjualan/show.blade.php ENDPATH**/ ?>