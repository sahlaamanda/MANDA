        ...
        <form action="<?php echo e(route('admin.jenis.update', $jenis->id)); ?>" method="POST">
            ...
            <div class="mb-3">
                ...
                <input
                    ...
                    name="nama_jenis"
                    class="form-control"
                    value="<?php echo e(old('nama_jenis', $jenis->nama)); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\pos_sahla18\resources\views/jenis/edit.blade.php ENDPATH**/ ?>