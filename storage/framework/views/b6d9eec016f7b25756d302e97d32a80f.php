    ...
    <div class="about-card">
        ...
        <div class="about-body">
            <div class="photo-wrap">
                <?php if(file_exists(public_path('images/foto-profil.png'))): ?>
                    <img src="<?php echo e(asset('images/foto-profil.png')); ?>" alt="Foto Profil" class="profile-photo">
                <?php else: ?>
        ...
        <div class="row g-3">
            ...
            <div class="col-6 col-md-3">
                <div class="project-item">
                    ...
                    <strong><?php echo e(phpversion()); ?></strong>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sahlaamandaa\resources\views/tentang/index.blade.php ENDPATH**/ ?>